...
class TvShowsFragment : Fragment() {
    ...
    fun initRV() {
        popTvList = ArrayList()
        binding.popTvRV.layoutManager = LinearLayoutManager(requireActivity().baseContext, LinearLayoutManager.HORIZONTAL, false)
        ...
        binding.topRatedRV.layoutManager = LinearLayoutManager(requireActivity().baseContext, LinearLayoutManager.HORIZONTAL, false)
        ...
        linearLayoutManager = CarouselLayoutManager(true, true, 0.5f, true, true, true,
